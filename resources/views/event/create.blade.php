                ...
                <form action="{{ route('evento.store') }}" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="Bienal do Livro de São Paulo">
                    ...
                    <div class="form-floating mb-3">
                        <input type="numer" min='1' step="1" class="form-control" id="maximum_capacity"
                            name="maximum_capacity" placeholder="100">
                        <label for="maximum_capacity">Capacidade Máxima de Participantes</label>
                    </div>

                    <div class="form-floating mb-3">
                        <textarea class="form-control" placeholder="Faça a descrição do evento aqui" id="description" style="height: 100px"></textarea>
